        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                  ...
                  <a href="login.php" class="nav-link"><span data-hover="Login">Dash!board</span></a>
                          </li>
            </ul>
...
<div class="container">
  <div id="login">
    ...
    <form action="" method="POST">
        ...
        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text bg-red text-white"><strong style="letter-spacing:2px"><?php echo $_SESSION['captcha'] ?></strong></span>
            </div>
...
<footer>
			<div class="container">
				<small>Copyright &copy; 2021 - Fahmi Aji Wicaksono</small>
			</div>
		</footer>